"use strict";
var replay_after_rerender_1 = require('../../../src/browser/replay/replay_after_rerender');
describe('replay_after_rerender', function () {
    describe('replayEvents()', function () {
        ...
        it('should dispatch all events', function () {
            ...
            expect(preboot.dom.findClientNode).toHaveBeenCalledWith(node1, 'node1');
            expect(preboot.dom.findClientNode).toHaveBeenCalledWith(node2, 'node2');
