...
describe('dom', function () {
    ...
    describe('getSelection', function () {
        ...
        it('should return the length of the node text if nothing else', function () {
            var node = { focus: function () { }, value: 'booyeah' };
            dom.state.document = {};
            var expected = { start: 7, end: 7, direction: 'forward' };
            var actual = dom.getSelection(node);
        ...
        it('should return if node.selectionStart exists', function () {
            ...
            var expected = { start: 1, end: 3, direction: 'backward' };
            var actual = dom.getSelection(node);
            expect(actual).toEqual(expected);
        });
    });
